        ...
        <section className='about-me'>
            ...
            <div className="about-me__front">
                <div className='about-me__info'>
                    ...
                    <a className='about-me__github' href="src/components/Main/AboutMe/AboutMe#">Github</a>
                </div>
            ...
            <ul className="about-me__portfolio">
                <li className="about-me__page">
                    <a className="about-me__link" href="src/components/Main/AboutMe/AboutMe#">
                        ...
                        <svg className='about-me__svg' xmlns="http://www.w3.org/2000/svg" width="18" height="17" fill="none"><path fill="#000" d="m2.607 16.524 12.357-12.38-.02 9.546h2.322V.182H3.778l-.02 2.301h9.545L.945 14.863l1.662 1.661Z"/></svg>
                    </a>
                </li>
                <li className="about-me__page">
                    <a className="about-me__link" href="src/components/Main/AboutMe/AboutMe#">
