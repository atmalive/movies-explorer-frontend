            ...
            <div className="about-me__front">
                <div className="about-me__info">
                    ...
                    <p className="about-me__text">
                        Я родился и живу на острове, закончил местный технарь. У меня есть жена и 7 дочерей. Я люблю бегать музыку, а ещё
                        слушать бег. Недавно начал кодить. С 2015 года работал в ресторане «ООО Макдональдс». После того, как прошёл курс по
                        веб-разработке, начал заниматься фриланс-заказами и ушёл с постоянной, любимой работы.
                    </p>
